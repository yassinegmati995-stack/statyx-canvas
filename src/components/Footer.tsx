      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-3 text-xs leading-relaxed text-muted-foreground">
              Premium streetwear inspired by freedom, individuality, and the poetry of flight.
            </p>
          </div>

          {/* Shop */}
          <div>
            <p className="mb-4 text-xs font-medium tracking-[0.2em] uppercase text-muted-foreground">Shop</p>
            <ul className="space-y-2.5">
              {["New Arrivals", "Hoodies", "Joggers", "T-Shirts", "Accessories"].map((item) => (
                <li key={item}>
          ...
          {/* Company */}
          <div>
            <p className="mb-4 text-xs font-medium tracking-[0.2em] uppercase text-muted-foreground">Company</p>
            <ul className="space-y-2.5">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
          <p className="text-xs text-muted-foreground">
            © 2026 Statyx. All rights reserved.
          </p>
