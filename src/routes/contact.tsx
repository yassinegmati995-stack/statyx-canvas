...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Statyx — Nous Contacter" },
      { name: "description", content: "Contactez Statyx pour vos demandes, collaborations ou support." },
      { property: "og:title", content: "Contact Statyx" },
      { property: "og:description", content: "Contactez-nous pour vos demandes, collaborations ou support." },
    ],
  }),
